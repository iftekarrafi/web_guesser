...
When we named the file .erb we were telling Sinatra that we're creating an ERB file. ERB stands for Embedded Ru**b**y -- it's a way of mixing plain text and Ruby together.
